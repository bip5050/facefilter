...
var JeelizResizer=(function(){
	window.addEventListener("resize", resize_fullScreen);
	//private vars :
	var _domCanvas, _whCanvasPx, _resizeAttemptsCounter=0, _overSamplingFactor=1, _isFullScreen=true, _timerFullScreen=true, _callbackResize=true;
